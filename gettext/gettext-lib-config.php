...
_x( 'Commerce Manager Catalog Feed XML', 'option label', 'wpsso-commerce-manager-catalog-feed' );
_x( 'Atom 1.0', 'option value', 'wpsso-commerce-manager-catalog-feed' );
_x( 'RSS 2.0', 'option value', 'wpsso-commerce-manager-catalog-feed' );
