...
**Version 2.9.0-dev.11 (2021/11/04)**
...
(2023/04/13) Replaced the `WpssoCmcfXml::get_meta_query()` private method by a new public method in WPSSO Core v15.8.0.
